...
fun Route.fileRoutes(
    ...
    get("/web/files") {
        ...
        if (trustManager.isDeviceBlocked(deviceId)) {
            call.respond(HttpStatusCode.Forbidden, "This companion has been blocked by host controller.")
            return@get
        }
        ...
        async function checkConnection() {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    showAuth();
                    authError.textContent = "Your connection has been blocked by host.";
                ...
                xhr.onreadystatechange = () => {
                    if (xhr.readyState === XMLHttpRequest.DONE) {
                        if (xhr.status === 200) {
                            ...
                            alert('Transaction forbidden: your device is blocked by the host controller.');
        ...
        async function deleteFile(fileName) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    alert('Action forbidden: your device and session is blocked by host controller.');
                } else {
